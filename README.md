...
Pure **Swift 6 + AppKit** (SwiftUI used only for Settings UI). macOS 26+. No external dependencies. The Xcode project is generated by [xcodegen](https://github.com/yonaskolb/XcodeGen) from `src/project.yml`.
