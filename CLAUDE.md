...
- **Code signing**: `project.yml` hard-codes `CODE_SIGN_STYLE: Manual` and `DEVELOPMENT_TEAM: M9Y77E7ZX5`. Do not remove — TCC (Screen Recording) requires stable team identity.
